...
namespace solar
{
    ...
    [[nodiscard]] PURE_FUNCTION auto Vec3::y() const -> double { return this->internal_vector[1]; }

    [[nodiscard]] PURE_FUNCTION auto Vec3::z() const -> double { return this->internal_vector[2]; }

    void Vec3::set_x(double input_x) { this->internal_vector.insert(0, input_x); }

    void Vec3::set_y(double input_y) { this->internal_vector.insert(1, input_y); }

    void Vec3::set_z(double input_z) { this->internal_vector.insert(2, input_z); }
    ...
    void Vec3::make_unit_vector() { this->internal_vector *= inv_sqrt(squared_length()); }
    ...
    [[nodiscard]] PURE_FUNCTION auto operator+(const Vec3& vec1, const Vec3& vec2) -> Vec3
    {
    ...
    [[nodiscard]] PURE_FUNCTION auto operator*(const Vec3& vec1, const double& value) -> Vec3
    {
        return vec1.get_vec() * value;
    }

    [[nodiscard]] PURE_FUNCTION auto operator*(const double& value, const Vec3& vec1) -> Vec3
    {
        return vec1.get_vec() * value;
    }
    ...
    [[nodiscard]] PURE_FUNCTION auto dot(const Vec3& vec1, const Vec3& vec2) -> double
    {
    ...
    [[nodiscard]] PURE_FUNCTION auto cross(const Vec3& vec1, const Vec3& vec2) -> Vec3
    {
    ...
    [[nodiscard]] PURE_FUNCTION auto determinant(const Vec3& vec1, const Vec3& vec2,
    ...
    [[nodiscard]] PURE_FUNCTION auto cramer(const Vec3& vec1, const Vec3& vec2, const Vec3& vec3,

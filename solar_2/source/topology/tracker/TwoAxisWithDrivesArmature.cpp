...
/*
    ...
    kDriveSecondaryS,
*/
void TwoAxisWithDrivesArmature::setPara(const int property_type, const QVariant& value)
{
...
auto TwoAxisWithDrivesArmature::getPara(const int property_type) const -> QVariant
{
    QVariant ret;
    switch(property_type)
    {

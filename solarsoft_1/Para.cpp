...
*/
Sun::Sun(double _azimuth, double _elevation, double _irradiance, bool _trackable, int _sunshape_type,double _sunshape)
    :azimuth(_azimuth), elevation(_elevation),irradiance(_irradiance),trackable(_trackable)
{
    reallocateSunshape(_sunshape_type);
    if(sunshape) sunshape->setPara(_sunshape);
}
Sun::~Sun()
{

...
void ParaTreeViewController::updatePara(const QModelIndex& index, QVariant value)  //更新para，存到sun里面
{
    qDebug()<<"click paratreeviewcontroller: "<<m_TreeModel->getNodeColumn(index,0)<<": "<<value.toString();

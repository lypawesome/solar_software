...
public:
    Sun(double _azimuth, double _elevation, double _irradiance, bool _trackable, int _sunshape_type);
...
public:
    Camera(){};
    Camera(const Vec3& _position,const Vec3& _rotation_axis, double _rotation_angle, bool _perspective);
...
public:
    Terrain(){};
    Terrain(bool _grid, bool _fill, const Vec3& _steps, const Vec3& _division, const Vec3& _min, const Vec3& _max,const QString& _file)
...
public:
    Cloud(){};
    Cloud(const Vec3& _coordinate, double _length, double _width, QString _file)

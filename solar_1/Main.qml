    ...
    header:ToolBar{
        ...
        Row{
            ...
            ToolButton{
                ...
                width:30
                icon.source: "qrc:/solar_1/icon/start.png"
                //!!!!!注意：：：这里使用相对路径会出问题，但是最后打包发布也不可以用绝对路径！！！打包发布时需要改bug
                //icon.source: "file:///D:/E/0_MyCode/QT_qml/qt6_5/solar_1/icon/start.png"
                icon.color:"#36ab60"
                icon.height:22
                background:Rectangle{
            ...
            ToolButton{
                ...
                icon.source: "file:///D:/E/0_MyCode/QT_qml/qt6_5/solar_1/icon/system.png"
                icon.color:"#36ab60"
                icon.height:22
                background:Rectangle{
                    color:parent.down ? "lightgray":"white"
            ...
            ToolButton{
                ...
                icon.source: "file:///D:/E/0_MyCode/QT_qml/qt6_5/solar_1/icon/parameter.png"
                icon.color:"#36ab60"
                icon.height:22
                background:Rectangle{
                    color:parent.down ? "lightgray":"white"
            ...
            ToolButton{
                ...
                icon.source: "file:///D:/E/0_MyCode/QT_qml/qt6_5/solar_1/icon/edit.png"
                icon.color:"#36ab60"
                icon.height:22
                background:Rectangle{
                    color:parent.down ? "lightgray":"white"
            ...
            ToolButton{
                ...
                icon.source: "file:///D:/E/0_MyCode/QT_qml/qt6_5/solar_1/icon/task.png"
                icon.color:"#36ab60"
                icon.height:22
                background:Rectangle{
                    color:parent.down ? "lightgray":"white"
            ...
            ToolButton{
                ...
                icon.source: "file:///D:/E/0_MyCode/QT_qml/qt6_5/solar_1/icon/result.png"
                icon.color:"#36ab60"
                icon.height:22
                background:Rectangle{
                    color:parent.down ? "lightgray":"white"

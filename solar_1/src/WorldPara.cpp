...
namespace solar
{
    ...
    */
    ...
    {
        qDebug() << "WorldPara::Location: site_name=" << site_name
    ...
    */
    Sun::Sun(double _azimuth, double _elevation, double _irradiance,
        ...
        : azimuth(_azimuth), elevation(_elevation), irradiance(_irradiance),
    ...
    void Sun::testPrint() const
    {
        qDebug() << "WorldPara::Sun: azimuth=" << azimuth
                 << " elevation=" << elevation << " irradiance=" << irradiance
                 << " trackable=" << trackable << "\n \t\t"
    ...
    void Sun::reallocateSunshape(int _sunshape_type)
    {
        ...
        {
        case PILLBOX:
            sunshape = new PillboxSunShape();
            break;
        case BUIE:
            sunshape = new BuieSunShape();
            break;
        case GAUSSION:
            sunshape = new GaussionSunShape();
            break;
        default:
        {
    ...
    */
    ...
    Camera::Camera(const Vec3& _position, const Vec3& _rotation_axis,
        ...
        : position(_position), rotation_angle(_rotation_angle),
          rotation_axis(_rotation_axis), perspective(_perspective)
    {
        lookat = Vec3(0, 0, 0);
